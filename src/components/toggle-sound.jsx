function ToggleSound({ audioIsEnabled, setAudioIsEnabled, playClickSound}) {
  function ToggleIcon() {
    if (audioIsEnabled) {
      return (
  ...
  return (
    ...
    >
      <div className="border-b-2 border-r-2 border-slate-500 rounded-md p-2">
        <div className="drop-shadow-[2px_2px_0px_rgba(0,0,0,0.4)]">
          <ToggleIcon audioIsEnabled={audioIsEnabled}></ToggleIcon>
        </div>
      </div>
    </button>
  );
